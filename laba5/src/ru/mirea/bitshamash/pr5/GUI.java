package ru.mirea.bitshamash.pr5;
import java.awt.*;
...
public class GUI {
    ...
    public static void main(String[] args) {
        ...
        kom1 = new JButton("AC Milan");
        kom2 = new JButton("Real Madrid");
        ...
        cp.add(label2);
        cp.add(label3);
        kom1.addActionListener(new ActionListener()
        {
        ...
        kom2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                count2++;
                label1.setText("Result: " + count1 + " X " + count2);
